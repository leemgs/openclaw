...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "gemini", "grok", "kimi", "perplexity", "tavily", or "searxng"). Auto-detected from available API keys if omitted.',
  ...
  "tools.web.search.perplexity.model":
    'Perplexity model override (default: "perplexity/sonar-pro"). Setting this opts Perplexity into the legacy chat-completions compatibility path.',

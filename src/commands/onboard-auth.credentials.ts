...
export const OWL_DEFAULT_MODEL_REF = "owl/custom_model2-37b-instruct";
...
export async function setOwlApiKey(
  key: SecretInput,
  agentDir?: string,
  options?: ApiKeyStorageOptions,
) {
  upsertAuthProfile({
    ...
    credential: buildApiKeyCredential("owl", key, undefined, options),
    agentDir: resolveAuthAgentDir(agentDir),
  });
}
